...
const Footer = () => {
  return (
    <div className="text-slate-600 my-10 flex gap-1 items-center">
      <Text size="small" className="text-slate-600">
        Made with Next.js, Tailwind, Framer Motion by Pawan Kanhere.
      </Text>

      <Link target="_blank" href="https://github.com/pawankanhere/portfolio">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" className="text-slate-600">
          <path
            fill="currentColor"
