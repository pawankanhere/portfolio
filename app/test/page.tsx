...
const Test = () => {
  return (
    <div className="min-h-screen w-full relative [background:radial-gradient(farthest-corner_at_100%_100%,#083344_10%,#000_70%)]">
      <div className="h-full w-full">
        <div className="container mx-auto mt-10">
          <div className="mt-10 absolute inset-0 z-0 space-y-3 h-[800px] p-10 bg-grid-slate-800 rounded-xl [mask-image:radial-gradient(farthest-corner_at_50%_40%,black_0%,transparent)]" />
          <div className="relative z-10 text-slate-400">
            <div className="mt-40 relative">
              <div className="absolute w-80 -top-5 flex h-0.5">
